...
def main():
    ...
    print(y_core_kmeans.value_counts())
    ...
    print(classification_report(y_test_full, y_pred_core_kmeans, labels=labels, target_names=target_names_adjusted, zero_division=0))
    ...
    print(f"Compressed Core Model Test Accuracy: {rf_core_kmeans.score(X_test_full_var, y_test_full):.4f}")
