...
def main():
    ...
    nodes = [f'node{i}' for i in range(8)]  # Adjusted node count
    ...
    # ==============================================
    # Step 4: DBSCAN Clustering for Core Set Selection
    # ==============================================
    print("\n=== Step 4: DBSCAN Clustering for Core Set Selection ===")
    ...
    print(f"Accuracy of core set model on full data: {accuracy_full_core:.4f}")
    ...
    compression_ratio = original_data_size / core_set_size
    ...
    summary_df = pd.DataFrame({
        ...
        'Compression Ratio': [compression_ratio, 'N/A', 'N/A']
    })
